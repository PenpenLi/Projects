...
-- 运营商
SPECIFIC_OP_ID = SPECIFIC_OP_IDS.QIANGWAN
...
PROXY_CLASS = "app.platform.qiangwan.QiangwanSdkProxy"
...
--平台自己的资源
PLATFORM_RES = {
	LOGIN_BG = "platform/qiangwan/login.jpg",
	LOGIN_LOGO = "platform/qiangwan/logo.png",
	--LOGIN_BG_ALIGN = 1,-- 0 中间 1 上 2 下
	CARD_FACE = "platform/qiangwan/card.png",
}
