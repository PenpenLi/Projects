...
SDK_TYPE = SDK_TYPES.ZHISHANG_IOS
...
SERVERLIST_URL_TEMPLATE = 
	...
	"?op_id=" .. SPECIFIC_OP_ID .. 
	"&sdk_type=" .. SDK_TYPE .. 
	"&platform_id=" .. SPECIFIC_GAME_OP_ID .. 
...
PROXY_CLASS = "app.platform.zhishang.ZhiShangsdkProxyIos"

PRODUCT_TYPE = 2--recharge_info 里面的读取相关
