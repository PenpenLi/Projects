...
--
local AttackOrderIcon = class("AttackOrderIcon",function()
	return ccui.Layout:create()
end)

AttackOrderIcon.TYPE_NORMAL = 1--
AttackOrderIcon.TYPE_SMALL_ENEMY = 2--缩略图敌人
AttackOrderIcon.TYPE_SMALL_MY = 3--缩略图自己的阵容

function AttackOrderIcon:ctor(type)
	-- body
	self._type = type == nil and AttackOrderIcon.TYPE_NORMAL or type
