...
function SkeletonEntry:ctor(spJson, objects, battleField, eventHandler, jumpToEvent, repeated)
    ...
    self._spJsonContent = configCache:getConfig(spJsonName)
    ...
    -- 加载资源
    if self._spJsonContent.png or cc.FileUtils:getInstance():isFileExist(cc.FileUtils:getInstance():fullPathForFilename(spFilePath..".png")) then
