...
int lua_cocos2dx_extension_AssetsManagerEx_decompress(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::AssetsManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_extension_AssetsManagerEx_decompress'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "cc.AssetsManagerEx:decompress");

        ok &= luaval_to_std_string(tolua_S, 3,&arg1, "cc.AssetsManagerEx:decompress");

        ok &= luaval_to_std_string(tolua_S, 4,&arg2, "cc.AssetsManagerEx:decompress");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_AssetsManagerEx_decompress'", nullptr);
            return 0;
        }
        bool ret = cobj->decompress(arg0, arg1, arg2);
        tolua_pushboolean(tolua_S,(bool)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.AssetsManagerEx:decompress",argc, 3);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_extension_AssetsManagerEx_decompress'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_extension_AssetsManagerEx(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"AssetsManagerEx");
        ...
        tolua_function(tolua_S,"decompress",lua_cocos2dx_extension_AssetsManagerEx_decompress);
