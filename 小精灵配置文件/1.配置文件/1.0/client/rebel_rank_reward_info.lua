...
rebel_rank_reward_info = {
    ...
    [3] = {3,1,3,3,15,0,2500,},
    [4] = {4,1,4,5,15,0,2000,},
    [5] = {5,1,6,10,15,0,1500,},
    [6] = {6,1,11,30,15,0,1250,},
    [7] = {7,1,31,50,15,0,1000,},
    [8] = {8,1,51,100,15,0,750,},
    [9] = {9,1,101,200,15,0,500,},
    [10] = {10,2,1,1,15,0,2000,},
    [11] = {11,2,2,2,15,0,1850,},
    [12] = {12,2,3,3,15,0,1600,},
    [13] = {13,2,4,5,15,0,1350,},
    [14] = {14,2,6,10,15,0,1000,},
    [15] = {15,2,11,30,15,0,850,},
    [16] = {16,2,31,50,15,0,700,},
    [17] = {17,2,51,100,15,0,500,},
    [18] = {18,2,101,200,15,0,350,},
...
function rebel_rank_reward_info.get(id)
    local k = id
    return rebel_rank_reward_info.indexOf(__index_id[k])
end
