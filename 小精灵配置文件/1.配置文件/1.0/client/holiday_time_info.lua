...
record_holiday_time_info.name = "" --名字
...
holiday_time_info = {
    _data = {
    [1] = {1,"双12活动",1449763200,1450022400,1450022400,"drop_info_holiday.xml","dungeon_info_holiday.lua","1",},
    }
}
...
function holiday_time_info.get(id)
    local k = id
    return holiday_time_info.indexOf(__index_id[k])
end
