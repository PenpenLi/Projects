...
record_Harmony6_info.dungeon_stageId = 0 --原英雄ID
record_Harmony6_info.resId = 0 --和谐英雄ID
...
function Harmony6_info.get(dungeon_stageId)
    local k = dungeon_stageId
    return Harmony6_info.indexOf(__index_dungeon_stageId[k])
end
