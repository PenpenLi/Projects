...
arena_reward_info = {
    _data = {
    [1] = {1,1,1,1,9,0,5000,1,0,120000,3,9,50,},
    [2] = {2,1,2,5,9,0,4000,1,0,100000,3,9,40,},
    [3] = {3,1,6,20,9,0,3500,1,0,80000,3,9,35,},
    [4] = {4,1,21,50,9,0,3000,1,0,50000,3,9,30,},
    [5] = {5,1,51,100,9,0,2500,1,0,30000,3,9,25,},
    [6] = {6,1,101,300,9,0,2000,1,0,20000,3,9,20,},
    [7] = {7,1,301,1000,9,0,1000,1,0,10000,3,9,10,},
...
function arena_reward_info.get(id)
    local k = id
    return arena_reward_info.indexOf(__index_id[k])
end
