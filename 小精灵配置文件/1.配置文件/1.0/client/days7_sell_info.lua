...
days7_sell_info = {
    _data = {
    [1] = {1,1,"暴走族装备全套",3,2,1,2,800,400,6000,},
    [2] = {2,2,"橙色徽章箱子*10",3,22,10,2,1200,600,5000,},
    [3] = {3,3,"极品精炼石*100",3,13,100,2,2000,1000,4000,},
    [4] = {4,4,"潜力胶囊*500(3折)",3,14,500,2,7500,2500,3000,},
    [5] = {5,5,"英魂*2000",13,0,2000,2,2000,1000,2500,},
    [6] = {6,6,"徽章精炼石*1000",3,18,1000,2,5000,2500,2000,},
    [7] = {7,7,"金币*500万",1,0,5000000,2,5000,2500,1500,},
    }
}
...
function days7_sell_info.get(id)
    local k = id
    return days7_sell_info.indexOf(__index_id[k])
end
