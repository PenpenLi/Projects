...
contest_points_buff_info = {
    _data = {
    [1] = {1,"超能联盟","超能联盟英雄伤害+10%","所有上阵的超能联盟英雄伤害加成+10%","ui/text/txt/zhenying_wei_xuanzhong.png","ui/text/txt/zhenying_wei.png",4101,},
    [2] = {2,"格斗联盟","格斗联盟英雄伤害+10%","所有上阵的格斗联盟英雄伤害加成+10%","ui/text/txt/zhenying_shu_xuanzhong.png","ui/text/txt/zhenying_shu.png",4102,},
    [3] = {3,"外星联盟","外星联盟英雄伤害+10%","所有上阵的外星联盟英雄伤害加成+10%","ui/text/txt/zhenying_wu_xuanzhong.png","ui/text/txt/zhenying_wu.png",4103,},
    [4] = {4,"怪人联盟","怪人联盟英雄伤害+10%","所有上阵的怪人联盟英雄伤害加成+10%","ui/text/txt/zhenying_qun_xuanzhong.png","ui/text/txt/zhenying_qun.png",4104,},
    }
}
...
function contest_points_buff_info.get(id)
    local k = id
    return contest_points_buff_info.indexOf(__index_id[k])
end
