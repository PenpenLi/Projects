...
daily_crosspvp_rank_title = {
    _data = {
    [1] = {1,10,4800,"光头英雄",7,22,150,23,150,},
    [2] = {2,100,4000,"S级英雄",6,22,120,23,120,},
    [3] = {3,300,3000,"A级英雄",5,22,100,23,100,},
    [4] = {4,0,3000,"B级英雄",4,22,80,23,80,},
    [5] = {5,0,1000,"C级英雄",3,22,50,23,50,},
    [6] = {6,0,500,"D级英雄",2,22,30,23,30,},
    [7] = {7,0,0,"见习英雄",1,0,0,0,0,},
    }
}
...
function daily_crosspvp_rank_title.get(id)
    local k = id
    return daily_crosspvp_rank_title.indexOf(__index_id[k])
end
