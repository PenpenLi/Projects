...
record_Harmony9_info.dead_battle_infoId = 0 --原英雄ID
record_Harmony9_info.resId = 0 --和谐英雄ID
...
function Harmony9_info.get(dead_battle_infoId)
    local k = dead_battle_infoId
    return Harmony9_info.indexOf(__index_dead_battle_infoId[k])
end
