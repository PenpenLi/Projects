...
ksoul_fight_base_info = {
    _data = {
    [1] = {1,"默认",1,1,2,0,0,"没有战斗光环，只有普通的影子。",},
    [2] = {2,"智慧",4,3,4,1,46,"让英雄在战斗中以智取胜。",},
    [3] = {3,"急速",5,5,6,2,57,"让英雄在战斗时身形灵巧，以速度取胜。",},
    [4] = {4,"强韧",6,7,8,3,52,"让英雄在战斗中提升防御，顽强不屈。",},
    [5] = {5,"认真",7,9,10,4,25,"让英雄在战斗中发挥真正的力量。",},
    }
}
