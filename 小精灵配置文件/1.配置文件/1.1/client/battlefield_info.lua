...
battlefield_info = {
    ...
    [2] = {2,50,2,2,26,1002,3,198,2,"第二关宝藏","这是战场第2关，战胜我可以获得额外宠魂",0,0,},
    [3] = {3,100,3,3,27,1003,3,198,3,"第三关宝藏","这是战场第3关，战胜我可以获得额外宠魂",0,0,},
    [4] = {4,150,4,4,28,1004,3,198,4,"第四关宝藏","这是战场第4关，战胜我可以获得额外宠魂",0,0,},
    }
}
...
function battlefield_info.get(id)
    local k = id
    return battlefield_info.indexOf(__index_id[k])
end
