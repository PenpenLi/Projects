...
daily_box_info = {
    ...
    [8] = {204,120,21,34,3,37,1,2,0,100,3,15,3,0,0,0,},
    [9] = {301,30,35,50,1,0,30000,2,0,20,0,0,0,0,0,0,},
    [10] = {302,60,35,50,1,0,60000,2,0,30,3,15,1,0,0,0,},
    [11] = {303,90,35,50,3,37,1,2,0,50,3,15,2,3,5,1,},
    [12] = {304,120,35,50,3,37,1,2,0,100,3,15,3,3,5,1,},
...
function daily_box_info.get(id)
    local k = id
    return daily_box_info.indexOf(__index_id[k])
end
