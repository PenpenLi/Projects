...
record_battlefield_position_info.prepose_id1 = 0 --前置关卡ID1
record_battlefield_position_info.prepose_id2 = 0 --前置关卡ID2
record_battlefield_position_info.prepose_id3 = 0 --前置关卡ID3
record_battlefield_position_info.prepose_id4 = 0 --前置关卡ID4
...
function battlefield_position_info.get(id)
    local k = id
    return battlefield_position_info.indexOf(__index_id[k])
end
