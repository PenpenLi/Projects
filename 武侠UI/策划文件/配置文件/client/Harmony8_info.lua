...
record_Harmony8_info.hard_dungeon_stageId = 0 --原英雄ID
record_Harmony8_info.resId = 0 --和谐英雄ID
...
function Harmony8_info.get(hard_dungeon_stageId)
    local k = hard_dungeon_stageId
    return Harmony8_info.indexOf(__index_hard_dungeon_stageId[k])
end
