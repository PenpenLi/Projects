...
record_knight_transform_info.advanced_code = 0 --英雄进阶码
record_knight_transform_info.cost = 0 --价格系数
record_knight_transform_info.constant = 0 --价格常量
record_knight_transform_info.cost_2 = 0 --消耗精华
...
function knight_transform_info.get(advanced_code)
    local k = advanced_code
    return knight_transform_info.indexOf(__index_advanced_code[k])
end
