...
record_role_quality_info.pre_knight_id = 0 --原英雄ID
record_role_quality_info.condition_type = 0 --条件类型
record_role_quality_info.condition_value = 0 --条件类型值
record_role_quality_info.result_id = 0 --变更后英雄ID
...
function role_quality_info.get(id)
    local k = id
    return role_quality_info.indexOf(__index_id[k])
end
