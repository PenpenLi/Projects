...
function TestProxy:_loginPlatform()
    print("TestProxy:_loginPlatform")
    ...
    if self._wantAutoEnterGame and self:getLoginUserName() ~= "" then
        ...
        print("TestProxy:_loginPlatform222", userName)
...
function TestProxy:getToken(opId, params, callback)
    ...
    url = url .. "?op_id=" .. opId .. "&pid=" .. params.uid .. "&token=test"
...
function TestProxy:getLoginUserName()
    print("TestProxy:getLoginUserName")
    ...
    if old then
        print("TestProxy:getLoginUserName", old.userName)
    end
    ...
    if proxyInfo then
        print("TestProxy:getLoginUserName3", proxyInfo.userName)
