...
task_info = {
    _data = {
    [1] = {101,"主线副本战斗胜利#num#次","ui/background/back_mainbt.png",},
    [2] = {102,"传说副本战斗胜利#num#次","ui/background/back_mainbt.png",},
    [3] = {103,"试炼塔挑战#num#次","ui/background/xingkong.png",},
    [4] = {104,"竞技场胜利#num#次","ui/background/bg_wujiang_info.png",},
    [5] = {105,"夺宝#num#次","ui/background/duobao.png",},
    [6] = {106,"活动期间获取#name##num#个","ui/background/duobao.png",},
    [7] = {107,"平息灾害#num#名","ui/background/bg_kfyw.png",},
    [8] = {108,"平息灾害#num#次","ui/background/bg_kfyw.png",},
    [9] = {109,"累计登陆#num#天","ui/background/bg_common.png",},
    [10] = {110,"精英副本战斗胜利#num#次","ui/background/back_mainbt.png",},
    [11] = {111,"幸运轮盘总积分达到#num#","ui/background/bg_common.png",},
    [12] = {112,"智能手机召唤#num#次","ui/background/bg_common.png",},
    [13] = {113,"寻找宝藏总积分达到#num#","ui/background/bg_common.png",},
    [14] = {114,"十二星座总积分达到#num#","ui/background/bg_common.png",},
    [15] = {115,"累计祈祷#num#次","ui/background/bg_common.png",},
    [16] = {201,"","ui/background/back_mainbt.png",},
    [17] = {202,"","ui/background/back_mainbt.png",},
    ...
    [22] = {207,"","ui/background/bg_kfyw.png",},
    [23] = {208,"","ui/background/bg_kfyw.png",},
    ...
    [31] = {304,"本日消耗钻石#num#","ui/background/bg_common.png",},
    [32] = {305,"活动期间总共消耗#num#钻石","ui/background/bg_common.png",},
...
function task_info.get(id)
    local k = id
    return task_info.indexOf(__index_id[k])
end
