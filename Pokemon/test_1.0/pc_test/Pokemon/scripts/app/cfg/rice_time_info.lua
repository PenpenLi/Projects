...
rice_time_info = {
    _data = {
    [1] = {1,3600,72000,86399,},
    [2] = {2,3600,72000,86399,},
    [3] = {3,3600,72000,86399,},
    [4] = {4,3600,72000,86399,},
    [5] = {5,3600,72000,86399,},
    [6] = {6,3600,72000,86399,},
    }
}
...
function rice_time_info.get(day)
    local k = day
    return rice_time_info.indexOf(__index_day[k])
end
