...
record_story_fight_info.npc1_id = 0 --1号位剧情英雄ID
record_story_fight_info.npc2_id = 0 --2号位剧情英雄ID
record_story_fight_info.npc3_id = 0 --3号位剧情英雄ID
record_story_fight_info.npc4_id = 0 --4号位剧情英雄ID
record_story_fight_info.npc5_id = 0 --5号位剧情英雄ID
record_story_fight_info.npc6_id = 0 --6号位剧情英雄ID
...
function story_fight_info.get(id)
    local k = id
    return story_fight_info.indexOf(__index_id[k])
end
