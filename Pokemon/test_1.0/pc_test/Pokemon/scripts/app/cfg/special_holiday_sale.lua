...
special_holiday_sale = {
    ...
    [9] = {69,2,1449763200,1450022400,"1",3,303,5,0,0,3,304,1,0,0,0,0,29,1,150,0,},
    [10] = {70,2,1449763200,1450022400,"1",1,0,50000,0,0,3,303,1,0,0,0,0,30,1,150,0,},
    [11] = {71,2,1449763200,1450022400,"1",13,0,100,0,0,3,303,2,0,0,0,0,31,1,150,200,},
    [12] = {72,2,1449763200,1450022400,"1",29,0,100,0,0,3,303,2,0,0,0,0,32,1,150,200,},
    [13] = {73,2,1449763200,1450022400,"1",6,50010,1,0,0,3,304,1,0,0,0,0,34,1,150,200,},
    [14] = {74,2,1449763200,1450022400,"1",6,50009,1,0,0,3,304,1,0,0,0,0,35,1,150,200,},
    [15] = {75,2,1449763200,1450022400,"1",3,275,1,0,0,3,303,20,0,0,0,0,36,1,150,15,},
    }
}
...
function special_holiday_sale.get(id)
    local k = id
    return special_holiday_sale.indexOf(__index_id[k])
end
