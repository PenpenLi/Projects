...
item_box_info = {
    ...
    [2] = {2,67,4,4,20034,1,4,40188,1,4,10023,1,4,40144,1,},
    [3] = {3,86,4,3,82,1,3,83,1,3,84,1,3,85,1,},
    [4] = {4,103,4,5,5001,1,5,5002,1,5,5003,1,5,5004,1,},
    [5] = {5,156,4,4,20045,1,4,10111,1,4,30078,1,4,10122,1,},
    [6] = {6,157,4,4,20067,1,4,30144,1,4,10012,1,4,30089,1,},
    [7] = {7,158,4,4,20056,1,4,40056,1,4,10034,1,4,40155,1,},
    [8] = {8,159,4,4,20012,1,4,30133,1,4,40012,1,4,10144,1,},
    [9] = {9,160,4,4,20023,1,4,10089,1,4,30067,1,4,10045,1,},
    ...
    [14] = {14,186,4,4,10001,1,4,30045,1,4,40045,1,4,30001,1,},
    [15] = {15,187,4,4,20001,1,4,40001,1,4,10056,1,4,20078,1,},
    ...
    [22] = {22,301,4,6,10001,1,6,10052,1,6,10075,1,6,10048,1,},
    [23] = {23,302,4,6,10025,1,6,10071,1,6,10006,1,6,10032,1,},
    }
}
...
function item_box_info.get(id)
    local k = id
    return item_box_info.indexOf(__index_id[k])
end
