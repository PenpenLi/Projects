...
Colors.inActiveSkill = ccc3(29, 233, 231)

Colors.activeSkill1 = ccc3(60, 227, 226)
Colors.inActiveSkill1 = ccc3(254, 243, 49)
Colors.helpdesc = ccc3(29, 233, 231)
...
--页签的颜色
Colors.TAB_NORMAL = ccc3(0x00,0xDE,0xFF)   --未选中
...
Colors.lightColors= {
    ...
    DESCRIPTION = ccc3(29, 233, 231),   --描述字
