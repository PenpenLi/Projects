local _data = {
    ...
    ["invite_content_base"] = "小伙伴们~陪我一起玩手游《" .. GAME_PACKAGE_NAME .. "》吧！童年的回忆，冒险的青春！真的很好玩！来吧，我们一起组建公会，奇遇冒险！我在【#serverName#】服务器，我叫#role_name#，ID：#id#，你可以在30级以前，在游戏的活动->新手礼包界面，绑定我的ID，与我建立伙伴关系！",
    ["invite_content_rich"] = "<root><text value='小伙伴们~陪我一起玩手游《" .. GAME_PACKAGE_NAME .. "》吧！童年的回忆，冒险的青春！真的很好玩！来吧，我们一起组建公会，奇遇冒险！我在' color='5258818'/><text value='【#serverName#】' color='11039782'/><text value='服务器，' color='5258818'/><text value='我叫#role_name#，ID：#id#' color='3509514'/><text value='，你可以在' color='5258818'/><text value='30级以前' color='12922112'/><text value='，在游戏的活动->新手礼包界面，绑定我的ID，与我建立伙伴关系！' color='5258818'/></root>",
...
function Setting:get(k)
    if not inited then
        ...
        print("setting init:", configContent)
