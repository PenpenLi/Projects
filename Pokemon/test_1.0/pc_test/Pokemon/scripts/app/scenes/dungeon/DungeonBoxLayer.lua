...
function DungeonBoxLayer:setStarBoxStatus(gateStar,isGet,conditionTxt,_totalStar)
    ...
    function setRichText()
        ...
        if _descLabel then 
            local str = "<content>" .. self:_appendRichText(G_lang:get("LANG_DUNGEON_REACH"), '1960423')
            str = str .. self:_appendRichText(conditionTxt .. G_lang:get("LANG_DUNGEON_STAR"), '1960423')
            str = str .. self:_appendRichText(G_lang:get("LANG_DUNGEON_GETBOUNS"), '1960423') .. "</content>"
