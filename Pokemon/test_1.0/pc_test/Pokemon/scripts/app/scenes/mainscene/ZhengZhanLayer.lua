...
function ZhengZhanLayer:onLayerLoad( jsonFile, func, fightType, ... )
    ...
    self:showWidgetByName("Button_crosswar", false)
	self:showWidgetByName("Button_dailypvp", false)
	self:showWidgetByName("Button_crusade",  false)
	self:showWidgetByName("Button_crosspvp", false)
