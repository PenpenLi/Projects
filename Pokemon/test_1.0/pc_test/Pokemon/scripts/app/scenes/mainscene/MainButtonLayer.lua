...
function MainButtonLayer:ctor(...)
    ...
    self._shopsList = {
        ...
        },
        {
         ...
         {
                btnName = "EquipShop",
                iconPath = "ui/common/icon-shangdian.png",
                txtPath = "ui/text/txt/cg_shenbingshangdian.png",
                clickFunc = function ( ... )
                    uf_sceneManager:pushScene(require("app.scenes.shop.score.ShopScoreSceneTwo").new(SCORE_TYPE.CHUANG_GUAN))
                end,
                showCheck = function ( ... )
                    return G_moduleUnlock:isModuleUnlock(FunctionLevelConst.TOWER_SCENE)
                end,
                needDetailTip = false, -- tip是否需要显示数字，例如邮件
                tipCheck = function ( ... )
        ...
        {   
                btnName = "shengwangShop",
                iconPath = "ui/common/icon-shangdian.png",
                txtPath = "ui/text/txt/jjc_shengwangshangdian.png",
                clickFunc = function ( ... )
                    uf_sceneManager:pushScene(require("app.scenes.shop.score.ShopScoreSceneTwo").new(SCORE_TYPE.JING_JI_CHANG))
                end,
                showCheck = function ( ... )
                    return G_moduleUnlock:isModuleUnlock(FunctionLevelConst.ARENA_SCENE)
                end,
                needDetailTip = false, -- tip是否需要显示数字，例如邮件
                tipCheck = function ( ... )
