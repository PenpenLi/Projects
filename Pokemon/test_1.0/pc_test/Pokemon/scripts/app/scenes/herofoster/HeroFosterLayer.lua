...
function HeroFosterLayer:onLayerLoad( ...  )
    ...
    self:enableLabelStroke("Label_knight_check", Colors.strokeOnePunch, 2 )
    self:enableLabelStroke("Label_fragment_check", Colors.strokeOnePunch, 2 )    
...
function HeroFosterLayer:_createStroke()
    self:getLabelByName("Label_count"):createStroke(Colors.strokeOnePunch,1)
    self:getLabelByName("Label_count_value"):createStroke(Colors.strokeOnePunch,1)
end
