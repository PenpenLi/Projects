...
function GuideBattleScene:_onStoryTalkEnd( ... )
    ...
    G_Loading:showLoading(function ( ... )
        self._battle = BattleLayer.create({msg = message, skip=BattleLayer.SkipConst.SKIP_NO, battleBg="pic/dungeonbattle_map/31000.png", moveFromOutside=true, moveFromOutsidePositions=move, curWave=2, double=2 }, 
