                ...
                if j%2 == 1 then    -- 对话
                    ...
                    if txt ~= "0" then
                        ...
                        local _createBubble = function()
                            ...
                            local label = G_GlobalFunc.createGameLabel(txt, 30, Colors.lightColors.DESCRIPTION, nil, CCSizeMake(180, 120))
                            bubble:addChild(label)
                            label:setPositionXY(bubble:getContentSize().width/2 + 23, bubble:getContentSize().height/2 - 10)
