...
function TreasureDevelopeLayer:_resetStrengthView()
    ...
    self:getImageViewByName("Image_luzi"):setVisible(false)
...
function TreasureDevelopeLayer:_resetRefineView()
    self._bg:loadTexture("ui/background/duobao.png")
    self._di:setVisible(false)
    if self._huoyan1 ~= nil then 
    ...
    --auto yuanjs
    local tiezhan =  self:getImageViewByName("Image_luzi")
    tiezhan:loadTexture("ui/yangcheng/tiezhan.png")
    tiezhan:setVisible(true)
