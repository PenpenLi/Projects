...
function LegionNewDungeonItem:ctor( ... )
    ...
    self:enableLabelStroke("Label_chapter_5", Colors.strokeBrown, 2 )
    ...
    self:enableLabelStroke("Label_Pass5", Colors.strokeBrown, 1 )
    ...
    self:enableLabelStroke("Label_progress_text_5", Colors.strokeBrown, 1 )
...
--	cellIndex, curChapterIndex, validChapter, maxChapterIndex)
	...
	local startChapterIndex = cellIndex*5
