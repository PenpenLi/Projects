...
function LegionNewDungeonListLayer:_initDungeonList( ... )
	...
	local cellMax = (self._showChapterMax % 5 ~= 0) and (self._showChapterMax/5 + 1) or self._showChapterMax/5
...
function LegionNewDungeonListLayer:countMoveOffset()
	...
	local cellMax = (showChapterMax % 5 ~= 0) and (showChapterMax/5 + 1) or showChapterMax/5
	cellMax = cellMax > 0 and cellMax or 1
	cellMax = math.floor(cellMax)

	local moveOffset = 0
	if showChapterMax%5 == 1 then
		moveOffset = LegionNewDungeonListLayer.DUNGEON_CELL_HEIGHT*0.8
	elseif showChapterMax%5 == 3 then
		moveOffset = LegionNewDungeonListLayer.DUNGEON_CELL_HEIGHT*0.4
	elseif showChapterMax%5 == 0 then
		--moveOffset = LegionDungeonListLayer.DUNGEON_CELL_HEIGHT*0.25
	elseif showChapterMax%5 == 2 then
		moveOffset = LegionNewDungeonListLayer.DUNGEON_CELL_HEIGHT*0.6
    elseif showChapterMax%5 == 4 then
		moveOffset = LegionNewDungeonListLayer.DUNGEON_CELL_HEIGHT*0.2
	end

	if showChapterMax%5 ~= 0 then
		...
		moveOffset = moveOffset + (cellMax*5 - self._curChapterIndex - 1)*LegionNewDungeonListLayer.DUNGEON_CELL_HEIGHT*0.25
...
function LegionNewDungeonListLayer:countScrollSpace( ... )
	...
	local scrollSpace = 0
	local cellMax = (maxShowChapterCount % 5 ~= 0) and (maxShowChapterCount/5 + 1) or maxShowChapterCount/5
	cellMax = cellMax > 0 and cellMax or 1
	cellMax = math.floor(cellMax)

	if maxShowChapterCount%5 == 1 then 
		scrollSpace = -LegionNewDungeonListLayer.DUNGEON_CELL_HEIGHT*0.8
	elseif maxShowChapterCount%5 == 2 then
		scrollSpace = -LegionNewDungeonListLayer.DUNGEON_CELL_HEIGHT*0.6
	elseif maxShowChapterCount%5 == 3 then
		scrollSpace = -LegionNewDungeonListLayer.DUNGEON_CELL_HEIGHT*0.4
    elseif maxShowChapterCount%5 == 4 then
		scrollSpace = -LegionNewDungeonListLayer.DUNGEON_CELL_HEIGHT*0.2
	elseif maxShowChapterCount%5 == 0 then
	end
	...
	__Log("cellMax:%d, countOffset:%d, _scrollSpace:%d", cellMax, maxShowChapterCount%5, scrollSpace)
	return scrollSpace
end
