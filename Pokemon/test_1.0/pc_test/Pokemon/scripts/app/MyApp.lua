...
function MyApp:run()
   ...
   --[[
    local buffer = CCFileUtils:sharedFileUtils():getXXTeaFileData("cs.pb", "6d2a4052c2") 
    local pb = require "UF.pbc.protobuf"
    pb.register(buffer )
    ]]

    local buffer = CCFileUtils:sharedFileUtils():getXXTeaFileData("cs.proto", "6d2a4052c2")
...
function MyApp:_toLoginScene()
    track_event_start("5-show_login")
