...
record_group_buy_award_info.type_3 = 0 --奖励类型3
record_group_buy_award_info.value_3 = 0 --奖励值3
record_group_buy_award_info.size_3 = 0 --奖励数量3
...
function group_buy_award_info.get(id)
    local k = id
    return group_buy_award_info.indexOf(__index_id[k])
end
