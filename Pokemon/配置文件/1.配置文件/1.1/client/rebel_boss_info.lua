...
record_rebel_boss_info.knight_id_1 = 0 --1号英雄id
record_rebel_boss_info.knight_id_2 = 0 --2号英雄id
record_rebel_boss_info.knight_id_3 = 0 --3号英雄id
record_rebel_boss_info.knight_id_4 = 0 --4号英雄id
record_rebel_boss_info.knight_id_5 = 0 --5号英雄id
record_rebel_boss_info.knight_id_6 = 0 --6号英雄id
...
rebel_boss_info = {
    _data = {
    [1] = {1,"狂暴敌人",14016,3520,3521,3522,3523,3524,3525,200,2,0,1,3,60,2,},
    [2] = {2,"狂暴敌人",14016,3520,3521,3522,3523,3524,3525,200,2,0,1,3,18,3,},
    [3] = {3,"狂暴敌人",14016,3520,3521,3522,3523,3524,3525,200,2,0,1,3,14,4,},
    [4] = {4,"狂暴敌人",14016,3520,3521,3522,3523,3524,3525,200,2,0,1,3,13,5,},
    }
}
...
function rebel_boss_info.get(id)
    local k = id
    return rebel_boss_info.indexOf(__index_id[k])
end
