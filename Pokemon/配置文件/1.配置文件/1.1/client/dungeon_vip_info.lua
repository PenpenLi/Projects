...
dungeon_vip_info = {
    _data = {
    [1] = {1,1,"金币副本",9001,20,1,0,"5万-30万","10万-60万",140193,"攻击我能获得金币，对我的伤害越高，获得的奖励越多哦！",31013,1,1000,1,0,10000,60000,1,0,16000,150000,1,0,22000,300000,1,0,28000,450000,1,0,34000,600000,1,0,40000,900000,1,0,46000,1500000,1,0,52000,},
    [2] = {2,2,"银经验雕像",9002,20,4,2002,"2个-10个","4个-20个",14016,"攻击我能获得银经验雕像，能在我手下下坚持越久，奖励越高哦！",31001,2,1,4,2002,2,2,4,2002,3,3,4,2002,4,4,4,2002,5,6,4,2002,7,8,4,2002,8,10,4,2002,9,12,4,2002,10,},
    [3] = {3,2,"经验徽章",9003,50,7,1,"2个-10个","4个-20个",14005,"攻击我能获得经验徽章，能在我手下下坚持越久，奖励越高哦！",31002,3,1,7,1,2,2,7,1,3,3,7,1,4,4,7,1,5,6,7,1,7,8,7,1,8,10,7,1,9,12,7,1,10,},
    [4] = {4,1,"进化石",9004,20,3,6,"40个-200个","80个-400个",130023,"攻击我能获得进化石，对我的伤害越高，获得的奖励越多哦！",31013,4,20000,3,6,4,50000,3,6,8,150000,3,6,12,300000,3,6,16,450000,3,6,22,600000,3,6,28,900000,3,6,34,1500000,3,6,40,},
    [5] = {5,1,"培养胶囊",9005,30,3,9,"20个-100个","40个-200个",130083,"攻击我能获得培养胶囊，对我的伤害越高，获得的奖励越多哦！",31001,5,20000,3,9,2,50000,3,9,4,150000,3,9,6,300000,3,9,8,450000,3,9,10,600000,3,9,12,900000,3,9,16,1500000,3,9,20,},
    ...
    [7] = {7,1,"徽章精炼",9007,50,3,18,"20个-100个","40个-200个",11014,"攻击我能获得徽章精炼石，对我的伤害越高，获得的奖励越多哦！",31013,7,20000,3,18,2,50000,3,18,4,150000,3,18,6,300000,3,18,8,450000,3,18,10,600000,3,18,12,900000,3,18,16,1500000,3,18,20,},
    [8] = {8,2,"潜力胶囊",9008,75,3,14,"10个-50个","20个-100个",11009,"攻击我能获得潜力胶囊，能在我手下下坚持越久，奖励越高哦！",31001,8,1,3,14,10,2,3,14,15,3,3,14,20,4,3,14,25,6,3,14,35,8,3,14,40,10,3,14,45,12,3,14,50,},
    }
}
...
function dungeon_vip_info.get(id)
    local k = id
    return dungeon_vip_info.indexOf(__index_id[k])
end
