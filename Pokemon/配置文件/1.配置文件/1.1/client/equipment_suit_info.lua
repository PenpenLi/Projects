...
equipment_suit_info = {
    _data = {
    [1] = {1000,"小贩套装",1001,1002,1003,1004,5,800,0,0,6,66,0,0,17,20,18,20,},
    [2] = {2000,"棒球套装",2001,2002,2003,2004,5,1400,0,0,6,115,0,0,17,40,18,40,},
    [3] = {2010,"暴走族套装",2011,2012,2013,2014,6,173,0,0,13,40,0,0,15,40,17,40,},
    [4] = {3000,"警察套装",3001,3002,3003,3004,5,2000,0,0,6,165,0,0,17,60,18,60,},
    [5] = {3010,"忍者套装",3011,3012,3013,3014,5,3000,0,0,14,60,0,0,16,60,18,60,},
    [6] = {3020,"终结者套装",3021,3022,3023,3024,6,247,0,0,13,60,0,0,15,60,17,60,},
    [7] = {4000,"李小龙套装",4001,4002,4003,4004,5,2600,0,0,6,214,0,0,17,80,18,80,},
    [8] = {4010,"007套装",4011,4012,4013,4014,5,3900,0,0,14,80,0,0,16,80,18,80,},
    [9] = {4020,"黑寡妇套装",4021,4022,4023,4024,6,321,0,0,13,80,0,0,15,80,17,80,},
    [10] = {5000,"美国队长套装",5001,5002,5003,5004,5,3200,0,0,6,264,0,0,17,100,18,100,},
    [11] = {6000,"金刚狼套装",6001,6002,6003,6004,5,3600,0,0,6,297,0,0,17,120,18,120,},
    [12] = {7000,"雷神套装",7001,7002,7003,7004,5,4000,0,0,6,330,0,0,17,140,18,140,},
    [13] = {7010,"蜘蛛侠套装",7011,7012,7013,7014,5,4000,0,0,6,330,0,0,17,140,18,140,},
    [14] = {7020,"钢铁侠套装",7021,7022,7023,7024,5,4000,0,0,6,330,0,0,17,140,18,140,},
    [15] = {7030,"蝙蝠侠套装",7031,7032,7033,7034,5,4000,0,0,6,330,0,0,17,140,18,140,},
    [16] = {7040,"超人套装",7041,7042,7043,7044,5,4000,0,0,6,330,0,0,17,140,18,140,},
    }
}
...
function equipment_suit_info.get(id)
    local k = id
    return equipment_suit_info.indexOf(__index_id[k])
end
