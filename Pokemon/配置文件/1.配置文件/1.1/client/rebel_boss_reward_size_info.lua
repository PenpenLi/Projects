...
record_rebel_boss_reward_size_info.type = 0 --数量类型
record_rebel_boss_reward_size_info.level_min = 0 --BOSS等级下限
record_rebel_boss_reward_size_info.level_max = 0 --BOSS等级上限
record_rebel_boss_reward_size_info.size = 0 --数量
...
function rebel_boss_reward_size_info.get(id)
    local k = id
    return rebel_boss_reward_size_info.indexOf(__index_id[k])
end
