...
group_buy_goods_info = {
    ...
    [9] = {9,3,186,1,5000,800,50,40,750,80,700,120,649,160,599,2,50,0,0,},
    [10] = {10,6,5001,6,1500,800,50,100,750,200,700,300,649,400,599,10,50,0,0,},
    [11] = {11,6,5002,6,1500,800,50,100,750,200,700,300,649,400,599,10,50,0,0,},
    [12] = {12,6,5003,6,1500,800,50,100,750,200,700,300,649,400,599,10,50,0,0,},
    [13] = {13,6,5004,6,1500,800,50,100,750,200,700,300,649,400,599,10,50,0,0,},
    ...
    [16] = {16,3,184,1,2500,750,100,60,700,120,649,180,599,240,549,3,50,0,0,},
    }
}
...
function group_buy_goods_info.get(id)
    local k = id
    return group_buy_goods_info.indexOf(__index_id[k])
end
