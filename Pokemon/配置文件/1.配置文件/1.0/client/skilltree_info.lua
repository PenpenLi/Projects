...
record_skilltree_info.front_skill = 0 --前置技能
...
skilltree_info = {
    _data = {
    [1] = {1,201,"强击",15,0,10,5,0,5,"强力攻击对位的敌人，造成500点伤害",},
    [2] = {2,202,"冲刺",30,201,20,8,0,8,"对对位的一列敌人造成400点伤害",},
    [3] = {3,203,"横扫",30,202,20,8,0,8,"对前排敌人造成350点伤害",},
    [4] = {4,204,"乱击",30,203,20,8,20,8,"对随机三名敌人均造成320点伤害",},
    [5] = {5,205,"波及",30,0,20,8,20,8,"对对位敌人造成400点伤害，并对其相邻敌人造成150点伤害",},
    }
}
...
function skilltree_info.get(id)
    local k = id
    return skilltree_info.indexOf(__index_id[k])
end
