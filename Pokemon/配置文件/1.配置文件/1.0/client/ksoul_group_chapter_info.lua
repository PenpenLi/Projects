...
ksoul_group_chapter_info = {
    _data = {
    [1] = {1,"C级英雄",1,1,7265792,55,0,0,},
    [2] = {2,"B级英雄",2,1,15561984,70,1,50,},
    [3] = {3,"A级英雄",3,1,7265792,85,2,50,},
    [4] = {4,"S级英雄",2,1,15561984,100,3,40,},
    }
}
...
function ksoul_group_chapter_info.get(id)
    local k = id
    return ksoul_group_chapter_info.indexOf(__index_id[k])
end
