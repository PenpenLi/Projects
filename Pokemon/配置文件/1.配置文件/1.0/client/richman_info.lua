...
richman_info = {
    _data = {
    [1] = {1,1,"人品爆发！可获取#num1#~#num2#的金币！","ui/dafuweng/qizi_yinliang.png",0,0,1,0,5000,15000,0,},
    [2] = {2,3,"偶遇神秘事件！会随机获得各种奖励，甚至有红色英雄礼包哦！","ui/dafuweng/qizi_shijian.png",0,0,0,0,0,0,0,},
    ...
    [8] = {8,3,"偶遇神秘事件！会随机获得各种奖励，甚至有红色英雄礼包哦！","ui/dafuweng/qizi_shijian.png",0,0,0,0,0,0,0,},
    ...
    [11] = {11,4,"红色主题商店，贩售红色英雄精华和红装矿石！","ui/dafuweng/qizi_daoju.png",0,0,0,0,0,0,1,},
    ...
    [14] = {14,3,"偶遇神秘事件！会随机获得各种奖励，甚至有红色英雄礼包哦！","ui/dafuweng/qizi_shijian.png",0,0,0,0,0,0,0,},
    ...
    [17] = {17,4,"极限养成主题商店，贩售高级精炼石、徽章精炼石和刷新石！","ui/dafuweng/qizi_daoju.png",0,0,0,0,0,0,2,},
    [18] = {18,2,"道具奖励！踩中该格可获取#num1#个#name#！","ui/dafuweng/qizi_shenmishangdian.png",2,1,3,13,1,1,0,},
    [19] = {19,1,"天降奇财！可获取#num1#~#num2#的金币！","ui/dafuweng/qizi_yinliang.png",0,0,1,0,5000,15000,0,},
    [20] = {20,3,"偶遇神秘事件！会随机获得各种奖励，甚至有红色英雄礼包哦！","ui/dafuweng/qizi_shijian.png",0,0,0,0,0,0,0,},
    ...
    [23] = {23,4,"英雄升星主题商店，贩售升星胶囊、星屑和刷新石！","ui/dafuweng/qizi_daoju.png",0,0,0,0,0,0,3,},
    ...
    [26] = {26,3,"偶遇神秘事件！会随机获得各种奖励，甚至有红色英雄礼包哦！","ui/dafuweng/qizi_shijian.png",0,0,0,0,0,0,0,},
    ...
    [32] = {32,3,"偶遇神秘事件！会随机获得各种奖励，甚至有红色英雄礼包哦！","ui/dafuweng/qizi_shijian.png",0,0,0,0,0,0,0,},
...
function richman_info.get(id)
    local k = id
    return richman_info.indexOf(__index_id[k])
end
