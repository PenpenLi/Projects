...
compose_info = {
    ...
    [4] = {4,70,199,26,1,"中级宠物经验道具",198,26,5,1000,999999,99999,},
    [5] = {5,70,200,26,1,"高级宠物经验道具",199,26,2,1000,999999,99999,},
    [6] = {6,70,203,27,1,"高级宠物圈",201,27,4,1000,999999,99999,},
    [7] = {7,70,203,27,1,"高级宠物圈",202,27,2,1000,999999,99999,},
    [8] = {8,70,290,26,1,"特级宠物经验道具",200,26,10,1000,999999,99999,},
    }
}
...
function compose_info.get(id)
    local k = id
    return compose_info.indexOf(__index_id[k])
end
